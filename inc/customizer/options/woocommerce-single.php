...
//trust
$wp_customize->add_setting( 'single_product_divider_1',
	array(
		'sanitize_callback' => 'esc_attr'
	)
);

$wp_customize->add_control( new Sydney_Divider_Control( $wp_customize, 'single_product_divider_1',
		array(
			'section' 		=> 'sydney_section_single_product',
			'priority'	 		=> 110
		)
...
$wp_customize->add_setting( 'single_product_trust_reasons_title',
	array(
		'default' 			=> '',
		'sanitize_callback' => 'esc_attr'
	)
...
$wp_customize->add_control( new Sydney_Text_Control( $wp_customize, 'single_product_trust_reasons_title',
		array(
			'label'				=> esc_html__( 'Product trust area', 'sydney' ),
			'section' 			=> 'sydney_section_single_product',
			'priority'	 		=> 110
		)
	)
...
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		...
		'swc_trust_badge_image',
		array(
		'label'          => __( 'Upload your trust badge image', 'sydney' ),
		'type'           => 'image',
		'section'        => 'sydney_section_single_product',
		'settings'       => 'swc_trust_badge_image',
		'priority'       => 110
		)
	)
);
...
$wp_customize->add_control(
	'swc_repeater_reasons_title',
	array(
		'label' => __( 'Title for the reasons to buy list', 'sydney' ),
		'section' => 'sydney_section_single_product',
		'type' => 'text',
		'priority' => 110
	)
...
// Reasons Sortable List
$wp_customize->add_setting(
	'swc_repeater_reasons',
	array(
		'default' => '',
...
$wp_customize->add_control(
	new Sydney_Repeater_Control(
		$wp_customize,
		'swc_repeater_reasons',
		array(
		'label'          => __( 'Reasons to buy list items', 'sydney' ),
		'type'           => 'sydney-repeater',
		'section'        => 'sydney_section_single_product',
		'settings'       => 'swc_repeater_reasons',
		'priority'       => 110
		)
	)
);
